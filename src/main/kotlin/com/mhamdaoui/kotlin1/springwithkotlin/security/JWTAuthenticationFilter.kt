...
import com.mhamdaoui.kotlin1.springwithkotlin.add
...
class JWTAuthenticationFilter(
    ...
    override fun attemptAuthentication(
        ...
        try {
            ...
            val creds = mapper
                    .readValue<com.mhamdaoui.kotlin1.springwithkotlin.model.User>(req.inputStream)
    ...
    override fun successfulAuthentication(
        ...
        val token = Jwts.builder()
                .setSubject((auth.principal as UserDetailsImpl).username)
                .claim("auth", claims)
        ...
        res.writer.write("{\"user_id\": 1, \"token\": \"$token\"}")
    }
}